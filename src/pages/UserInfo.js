...
const countryCode = [{ label: "+1" }, { label: "+91" }];
...
export default function UserInfo() {
  ...
  return (
    <div
      className="flex flex-col items-center justify-center overflow-auto pt-96  py-5"
      style={{
          ...
          >
            ...
            >
              ...
              >
                ...
                <Grid item>
                  <Button
                    className="m-5 bg-red-500 text-white rounded-full"
                    variant="outlined"
                  >
                    LOG OUT
                  </Button>
          ...
          >
            ...
            >
              <Box>
                <Card
                  variant="outlined"
                  className="bg-blue-600 bg- text-white"
                  sx={{
                    width: { 
                     xs: "60vw",
                     sm: "20rem" },
              ...
              >
                <Grid item>
                  <Button
                    className="m-2 bg-green-500 text-white rounded-full"
                    variant="outlined"
                    sx={{
                      // md: { width: "70%" },
                      // xs: { width: "95rem" },
                ...
                <Grid item>
                  <Button
                    className="m-2 bg-red-500 text-white rounded-full"
                    variant="outlined"
                    sx={{
                      md: { width: "70%" },
                      xs: { width: "95rem" },
                ...
                <Grid item>
                  <p className="m-2 text-white">
                    <Link href="#">Click Here</Link>, to know more about plans
                  </p>
                </Grid>
              </Box>
              <p className=""></p>
