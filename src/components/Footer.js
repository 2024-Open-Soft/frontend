            ...
            <Grid container spacing={1} sx={{ pb: 3 }}>
                <Grid item xs={12} md={6} lg={3}>
                    ...
                    <List>
                        ...
                        <ListItem sx={{ px: 0 }}>
                            <Link href="#" sx={linkStyle}>Careers</Link>
                        </ListItem>
                    </List>
                </Grid>
                <Grid item xs={12} md={6} lg={3}>
                    ...
                    <List>
                        <ListItem sx={{ px: 0 }}>
                            <Link href="#" sx={linkStyle}>English</Link>
                        </ListItem>
                        <ListItem sx={{ px: 0 }}>
                            <Link href="#" sx={linkStyle}>Hindi</Link>
                        </ListItem>
                    </List>
                </Grid>
                <Grid item xs={12} md={6} lg={3}>
                    ...
                    <List>
                        <ListItem sx={{ px: 0 }}>
                            <Link href="#" sx={linkStyle}>Visit Help Center</Link>
                        </ListItem>
                        <ListItem sx={{ px: 0 }}>
                            <Link href="#" sx={linkStyle}>Share Feedback</Link>
                        </ListItem>
                    </List>
                </Grid>
                <Grid item xs={12} md={6} lg={3}>
